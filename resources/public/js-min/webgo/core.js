...
*/
webgo.core.setOnePlayer = (function setOnePlayer(one_player){return cljs.core.reset_BANG_(webgo.core.mode,(function (){var G__7014 = one_player;if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(false,G__7014))
{return cljs.core.constant$keyword$30;
} else
{if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(true,G__7014))
...
{var n1_7015 = webgo.go.move.cljs$core$IFn$_invoke$arity$2(n,webgo.ai.next_board(n));webgo.gui.update_BANG_(webgo.core.ui,n1_7015);
...
*/
webgo.core.init = (function init(canvas_id,scorebar_id){var canvas = document.getElementById(canvas_id);var scorebar = document.getElementById(scorebar_id);var g = webgo.gui.make(canvas,scorebar,webgo.go.empty_board(9),1000,10);webgo.core.ui = g;
